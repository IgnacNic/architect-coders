...
import com.ignacnic.architectcoders.domain.userpreferences.PreferencesKeys
...
class LocationRequesterScreenViewModel(
    ...
    sealed interface SideEffect {
        ...
        data object LaunchAppDetailsSettings : SideEffect
    ...
    private fun onRationaleConfirmed() {
        ...
        viewModelScope.launch {
            _sideEffects.send(SideEffect.LaunchAppDetailsSettings)
        }
    }
